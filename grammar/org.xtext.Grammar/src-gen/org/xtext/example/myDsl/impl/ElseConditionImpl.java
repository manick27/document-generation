 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.myDsl.impl.ElseConditionImpl#getOtherElement <em>Other Element</em>}</li>
 *   <li>{@link org.xtext.example.myDsl.impl.ElseConditionImpl#getIfCondition <em>If Condition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ElseConditionImpl extends MinimalEObjectImpl.Container implements ElseCondition
{
  ...
  {
    return MyDslPackage.Literals.ELSE_CONDITION;
  }
  ...
  public EList<OtherElement> getOtherElement()
  {
    ...
    {
      otherElement = new EObjectContainmentEList<OtherElement>(OtherElement.class, this, MyDslPackage.ELSE_CONDITION__OTHER_ELEMENT);
    }
    return otherElement;
  }
  ...
  public NotificationChain basicSetIfCondition(IfCondition newIfCondition, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.ELSE_CONDITION__IF_CONDITION, oldIfCondition, newIfCondition);
  ...
  public void setIfCondition(IfCondition newIfCondition)
  {
    if (newIfCondition != ifCondition)
    {
      ...
      if (ifCondition != null)
        msgs = ((InternalEObject)ifCondition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.ELSE_CONDITION__IF_CONDITION, null, msgs);
      if (newIfCondition != null)
        msgs = ((InternalEObject)newIfCondition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.ELSE_CONDITION__IF_CONDITION, null, msgs);
      msgs = basicSetIfCondition(newIfCondition, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.ELSE_CONDITION__IF_CONDITION, newIfCondition, newIfCondition));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.ELSE_CONDITION__OTHER_ELEMENT:
        return ((InternalEList<?>)getOtherElement()).basicRemove(otherEnd, msgs);
      case MyDslPackage.ELSE_CONDITION__IF_CONDITION:
